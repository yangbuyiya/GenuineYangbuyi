...
<form class="layui-form" id="loginFrm" method="post" action="${yby}/login/login">
    <div class="login_face"><img src="${yby}/static/images/face.jpg" class="userAvatar"></div>
    ...
    <div class="layui-form-item input-item" id="imgCode">
        ...
        <img src="${yby}/login/getCode.action" onclick="this.src=this.src+'?'">
    </div>
    ...
    layui.use(['form','layer','jquery'],function(){
     ...
     /*   /!**
         ...
         form.on("submit(login)", function (data) {
                    $(this).text("登录中...").attr("disabled", "disabled").addClass("layui-disabled");
                    setTimeout(function () {
                        $.post("${yby}/login/login", $("form").serialize(), function (data) {
                            /!* 转换为Json数据 *!/
        data = $.parseJSON(data);
        if (data.success) {
            // /!* 跳转到首页 *!/
