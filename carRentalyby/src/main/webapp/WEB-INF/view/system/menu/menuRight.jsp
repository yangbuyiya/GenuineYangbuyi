...
<html>
	...
	<body style="padding: 30px;box-sizing: border-box">
		...
		<div style="display: none;" id="menuToolBar">
		    <shiro:hasPermission name="menu:addMenu">
                <button type="button" class="layui-btn layui-btn-sm" lay-event="add">增加</button>
            </shiro:hasPermission>
        <shiro:hasPermission name="menu:deleteBatch">
		...
		<div id="menuBar" style="display: none;" lay-filter="menuBar">
			<shiro:hasPermission name="menu:updateMenu">
                <a class="layui-btn layui-btn-xs" lay-event="edit">编辑</a>
            </shiro:hasPermission>
			<shiro:hasPermission name="menu:deleteMenu">
