...
<head>
    ...
    <link rel="stylesheet" href="${yby}/static/css/index.css" media="all"/>
    <style>
        @font-face {
            font-family: "seraph";
...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:;"><img src="${yby}/static/images/face.jpg" class="layui-nav-img userAvatar"
                                                width="35" height="35"><cite
                            class="adminName">${user.realname}</cite></a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" data-url="${yby}/sys/toUserInfoManager"><i
                                class="seraph icon-ziliao" data-icon="icon-ziliao"></i><cite>个人资料</cite></a></dd>
                        <dd><a href="javascript:;" data-url="${yby}/static/page/user/changePwd.html"><i
                        ...
                        <dd><a href="${yby}/login/logout" class="signOut"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${yby}/static/images/face.jpg" class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                <li class="layui-nav-item layui-this">
                    <a href="javascript:;" data-url="${yby}/static/page/main.html"><i class="layui-icon"
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <div class="layui-tab-content clildFrame">
                <div class="layui-tab-item layui-show">
                    <iframe src="${yby}/desk/toDescKManager"></iframe>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="layui-footer footer">
        <p><span>copyright @2020 杨不易</span></p>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['bodyTab', 'form', 'element', 'layer', 'jquery'], function () {
        ...
        tab = layui.bodyTab({
            ...
            url: "${yby}/menu/loadIndexLeftMenuJson" //获取菜单json地址
        });
