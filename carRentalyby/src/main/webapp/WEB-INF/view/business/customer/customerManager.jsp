        ...
        <form action="" class="layui-form" method="post" id="searchFrm" style="text-align: center;">
            ...
            <div class="layui-form-item" style="text-align: center;padding-top: 20px;">
                <div class="layui-inline">
                    ...
                    <button type="reset" class="layui-btn layui-btn-danger layui-btn-sm layui-icon layui-icon-export" id="doExport">
                        导出
                    </button>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            layui.use(['jquery', 'layer', 'form', 'table'], function () {
                ...
                $("#doExport").click(function () {
                    // 获取表单序列化
                    var params = $("#searchFrm").serialize();
                    window.location.href = "${yby}/stat/exportCustomer?"+params;
                });
