        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="search_rentid" id="search_rentid" autocomplete="off"
                       ...
                       placeholder="请输入出租单号" style="height: 30px;;width: 280px">
            </div>
    ...
    <form class="layui-form" method="post" id="checkFrm" lay-filter="checkFrm">
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="padding: 5px;width: 280px">
                    <input type="text" name="checkid" readonly="readonly"
                           class="layui-input layui-input-inline"
                           placeholder="请输入检查单号" style="height: 30px;;width: 280px">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">出租单号:</label>
            ...
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="padding: 5px;width: 280px">
                    <input type="text" name="opername" readonly="readonly" autocomplete="off"
                           class="layui-input layui-input-inline"
                           placeholder="请输入操作员" style="height: 30px;;width: 280px">
                </div>
            </div>
        </div>
        <div class="layui-form-item">
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="padding: 5px;width: 280px">
                    <input type="text" name="problem" id="problem" required  lay-verify="required" autocomplete="off"
                           class="layui-input layui-input-inline"
                           placeholder="请输入存在的问题" style="height: 30px;;width: 280px">
                </div>
            </div>
            <div class="layui-inline">
                <label class="layui-form-label">赔付金额:</label>
                <div class="layui-input-inline" style="padding: 5px;width: 280px">
                    <input type="text" name="paymoney" id="paymoney" required  lay-verify="required|number" autocomplete="off"
                           class="layui-input layui-input-inline"
                           placeholder="请输入赔付金额" style="height: 30px;;width: 280px">
                </div>
            </div>
            <div class="layui-inline">
                ...
                <div class="layui-input-inline" style="padding: 5px;width: 280px">
                    <input type="text" name="checkdate" id="checkdate" required  lay-verify="required"
                           class="layui-input layui-input-inline"
                           placeholder="请输入检查时间" style="height: 30px;;width: 280px">
                </div>
            </div>
        </div>
        ...
        <div class="layui-form-item" style="text-align: center">
            <button type="button" lay-submit="" lay-filter="doSubmit"
                    class="layui-btn layui-btn-normal layui-icon layui-icon-release  layui-btn-sm"
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        $("#doSearch").click(function () {
            ...
            $.post("${yby}/check/checkRentExist", {rentid: rentid}, function (obj) {
        ...
        function initCheckFormData(rentid) {
             ...
             * 出租单信息有车辆
             */
            $.post("${yby}/check/initCheckFormData",{rentid:rentid},function (obj) {
                //检查单
                var check=obj.check;
                // 初始化表单
                ...
                $("#car_carimg").attr("src","${yby}/file2/downloadShowFile2?path="+car.carimg);
            })
        }
        //保存
        form.on("submit(doSubmit)",function () {
            var params = $("#checkFrm").serialize();
            $.post("${yby}/check/saveCheck",params,function (obj) {
                layer.msg(obj.msg);
                $("#content").hide();
            })
            return false;
