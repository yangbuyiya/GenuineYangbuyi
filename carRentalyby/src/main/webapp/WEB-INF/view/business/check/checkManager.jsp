        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="checkdesc" autocomplete="off" class="layui-input layui-input-inline"
                       placeholder="请输入问题描述" style="height: 30px;width: 280px">
            </div>
        </div>
    </div>
    <div class="layui-form-item">
        ...
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="startTime" id="startTime" readonly="readonly"
                       ...
                       placeholder="请输入开始检查时间" style="height: 30px;width: 280px">
            </div>
        </div>
        <div class="layui-inline">
            ...
            <div class="layui-input-inline" style="padding: 5px;width: 280px">
                <input type="text" name="endTime" id="endTime" readonly="readonly"
                       class="layui-input layui-input-inline"
                       placeholder="请输入结束检查时间" style="height: 30px;width: 280px">
            </div>
        </div>
    </div>
    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        ...
        <div class="layui-form-item">
            <div class="layui-input-block" style="text-align: center;padding-right: 120px">
                ...
                <button type="reset"
                        class="layui-btn layui-btn-warm layui-btn-md layui-icon layui-icon-refresh ">重置
                </button>
            </div>
        </div>
    </form>
...
<script type="text/javascript">
    ...
    layui.use(['jquery', 'layer', 'form', 'table', 'laydate'], function () {
        ...
        tableIns = table.render({
            ...
            , url: '${yby}/check/loadAllCheck' //数据接口
        ...
        $("#doSearch").click(function () {
            ...
            tableIns.reload({
                url: "${yby}/check/loadAllCheck?" + params,
                page: {curr: 1}
            })
        });
        ...
        table.on("toolbar(checkTable)",function (obj) {
            ...
            if (layEvent==='deleteBatch'){
                ...
                layer.confirm('真的要删除这些检查单吗？',function (index) {
                    //向服务端发送删除指令
                    $.post("${yby}/check/deleteBatchCheck",params,function (res) {
                        layer.msg(res.msg);
                        tableIns.reload();
                    })
                })
        ...
        table.on('tool(checkTable)', function (obj) {
            ...
            if (layEvent === 'del') { //删除
                layer.confirm('真的删除【' + data.checkid + '】这个检查单么？', function (index) {
                    //向服务端发送删除指令
                    $.post("${yby}/check/deleteCheck", {checkid: data.checkid}, function (res) {
                        layer.msg(res.msg);
                        //刷新数据表格
                        tableIns.reload();
                    })
