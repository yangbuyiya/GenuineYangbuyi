...
public class AppFileUtils {
    ...
    static {
        ...
        try {
            ...
            /* 直接获取当前项目的路径保存 */
            String realPath = WebUtils.getHttpServletRequest().getSession().getServletContext().getRealPath(PATH);
            System.out.println("得到文件上传的路径" + realPath);
            PATH = realPath;
        } catch (IOException e) {
            e.printStackTrace();
        }
    ...
    public static String updateFileName(String carimg, String suffix) {
        ...
        try {
            ...
            if (file.exists()) {
                ...
                System.out.println("该名称:"+carimg.replace(suffix, ""));
