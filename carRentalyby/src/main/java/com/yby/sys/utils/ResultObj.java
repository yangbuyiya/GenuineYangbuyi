...
public class ResultObj {
     ...
     * 更新失败 不能选中自己为父菜单
     */
    public static final ResultObj UPDATE_SELECT_ERROR = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.UPDATE_SELECT_ERROR);
    /**
     * 更新失败 不能选中自己的子菜单为自己的父菜单
     */
    public static final ResultObj UPDATE_SELECT_CHILDREN_ERROR = new ResultObj(SysConstast.CODE_SUCCESS, SysConstast.UPDATE_SELECT_CHILDREN_ERROR);
    /**
     * 添加成功
     */
