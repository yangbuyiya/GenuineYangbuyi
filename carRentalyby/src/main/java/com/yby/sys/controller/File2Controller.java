...
public class File2Controller {
    ...
    @ResponseBody
    public DataGridView uploadFile2(MultipartFile mf) throws IllegalStateException, IOException {
        // 文件上传的父目录
     ...
     * 不下载只显示
     */
    @RequestMapping("downloadShowFile2")
    public ResponseEntity<Object> downloadShowFile2(String path, HttpServletResponse response) {
    ...
    public ResponseEntity<Object> downloadFile2(String path, HttpServletResponse response) {
        String oldName = "";
